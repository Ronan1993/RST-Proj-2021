...
public class PosterBehaviour : MonoBehaviour
{
    ...
    {
        GridLayoutGroup gridLayout = gameObject.AddComponent<GridLayoutGroup>() as GridLayoutGroup;
        ...
        foreach (Item item in orderedItemCollection)
        {
            ...
            imageObj.GetComponent<RectTransform>().SetParent(gameObject.transform);
            ...
            text.text = item.text;
            textObj.GetComponent<RectTransform>().SetParent(gameObject.transform);
            textObj.transform.Translate(new Vector3(0, -1 * imageObj.GetComponent<RectTransform>().rect.height, 0));
            textObj.SetActive(true);

            // Make spacing bigger now

            var arf = imageObj.AddComponent<AspectRatioFitter>() as AspectRatioFitter;
